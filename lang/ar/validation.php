...
return [
    ...
    */
    'attributes' => [
        ...
        'phone' => 'حقل الهاتف',
        'age' => 'حقل العمر',
        'Page' => 'الصفحة التعريفية',
        'expire' => 'تاريخ الإنتهاء',
        'sex' => 'حقل الجنس',
        'value' => 'القيمة',
        'It Is Allowed To Add Only Four Elements' => 'مسموح فقد بإضافة اربعة عدادات',
        'en.name' => 'الاسم باللغة الأنجليزية',
        'en_name' => 'الاسم باللغة الأنجليزية',
        'lat' => 'احداثيات Lat',
        'lng' => 'احداثيات Lng',
        'gender' => 'حقل الجنس',
        'day' => 'حقل اليوم',
        'birthday' => 'تاريخ الميلاد',
        'about_en' => 'التفاصيل باللغة الإنجليزية',
        'about' => 'التفاصيل باللغة العربية',
        'month' => 'حقل الشهر',
        'year' => 'حقل السنة',
        'hour' => 'حقل ساعة',
        'minute' => 'حقل دقيقة',
        ...
        'country_id'=>'الدوله',
        'name_en'=>'حقل الاسم باللغة الإنجليزية',
        'town_id'=>'المدينه',
