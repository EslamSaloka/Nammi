        ...
        <div class="card custom-card">
            @canAny('dues.export')
                <div class="d-flex mg-b-20">
                    <div class="pd-10 order-3">
                        <a class="btn btn-success" href="{{route('admin.revenue.club.export', [$club->id,request()->getQueryString()])}}">
            ...
            <div class="card-body">
                ...
                @canAny('dues.confirmed')
                    <a href="{{ route('admin.revenue.confirmed',[$club->id,request()->getQueryString()]) }}"
                        class="btn btn-success"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        data-bs-original-title="{{ __('Confirm Transfer All Revenue To This Club') }}"
                       @if (\App::getLocale() == "en")
                       style="position:absolute;left:140px;top:10px;width:20%"
                       @else
                       style="position:absolute;right:125px;top:10px;width:25%"
                        @endif
                    >
                        <i class="fa fa-money-check-alt"></i>
                        @lang('Confirm Transfer All Revenue To This Club')
                    </a>
                @endcanAny
                    ...
                    <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-lg-8p"><span>@lang('Revenue Date')</span></th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($lists as $list)
                                <tr>
                                    ...
                                    <td>
                                        {{ ($list->order_total_price - $list->price) }} @lang('EGP')
                                    </td>
                                    <td>
...
@include('admin.component.modals.filter', [
    ...
    'url' => route('admin.revenue.show',$club->id)
])
